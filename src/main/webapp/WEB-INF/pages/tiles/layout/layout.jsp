...
<html>
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/img/apple-touch-icon.png" rel="apple-touch-icon">
         ...
         <link href="${pageContext.request.contextPath}/resources/css/stylelogin.css" rel="stylesheet">
        <!-- Google Fonts -->
    ...
    <body>
        ...
        <script src="${pageContext.request.contextPath}/resources/js/jquery.backtotop.js"></script>
